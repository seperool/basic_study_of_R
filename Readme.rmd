...
- O pacote `lubridate` perimite o acesso ao tipo `date` (data) e funções para se trabalhar com esse tipo de variável.\
- Normalmente passamos uma variável do tipo **character**, no formato de data (ex.: 2006-05-29), para o tipo **date**.\
- Podemos passar do tipo **char** para o tipo **date** através das funções:\
  - `date(variável_chr)`\
